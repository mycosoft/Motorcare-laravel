...
@section('main')
    <div class="row">
        <div class="col-6"></div>
        <div class="col-6">
            @permission('gallery_categories.create')
                <a href="{{ route('admin.gallery-categories.create') }}" class="mt-3 btn btn-primary float-right">
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="datatables" data-route="{{ route('admin.gallery-categories.index') }}"
